    ...
    return FormField<ImageModel>(
      ...
      builder: (state) {
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start, // ← IMPORTANTE: Alinha à esquerda
          children: [
            ...
            // Mensagem de erro - AGORA POSICIONADA CORRETAMENTE
            if (state.hasError)
              Padding(
                padding: const EdgeInsets.only(left: 4, top: 8), // ← Padding mais consistente
                child: Text(
                  state.errorText!,
                  style: TextStyle(
