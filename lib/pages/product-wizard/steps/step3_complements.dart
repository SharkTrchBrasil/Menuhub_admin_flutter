...
class Step3Complements extends StatelessWidget {
  ...
  // ✅ CORRIGIDO: Agora obtém os dados do StoresManagerCubit corretamente
  Future<void> _openPanel(BuildContext context, {ProductVariantLink? linkToEdit}) async {
    ...
    // Valida se o estado da loja está carregado
    ...
    // ✅ PASSA OS DADOS NECESSÁRIOS COMO PARÂMETROS
  ...
  Widget _buildEmptyState(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SvgPicture.asset('assets/icons/food.svg', height: 120),
