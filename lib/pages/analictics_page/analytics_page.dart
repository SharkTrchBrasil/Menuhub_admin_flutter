...
//                     children: [
//                       Row(children: [
//                         Text("Overall Portfolio",style: Typographyy.heading5.copyWith(color: notifire.getTextColor)),
//                         const Spacer(),
//                         OutlinedButton(
...
//                                 shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12),side: BorderSide(color: notifire.getBgPrimaryColor))
//                             ),
//                             onPressed: (){}, child: Text("Withdraw",style: Typographyy.bodyMediumMedium.copyWith(color: notifire.getBgPrimaryColor),)),
...
//                       mainAxisSize: MainAxisSize.min,
//                       children: [
//                         Text("Overview Statistic",style: Typographyy.heading5.copyWith(color: notifire.getTextColor)),
//                         const Spacer(),
//                         Container(
//                           height: 30,
//                           width: 30,
...
//                             color: notifire.getGry700_800Color,
//                           ),
//                           child: Center(child: SvgPicture.asset("assets/images/star.svg",width: 20,height: 20,color: notifire.getBgPrimaryColor,)),
//                         ),
//                         const SizedBox(width: 8,),
//                         Container(
//                           height: 30,
...
//                   child: Text("Elon Musk",style: Typographyy.bodyMediumExtraBold.copyWith(color: notifire.getTextColor),),
//                 ),
//                 subtitle: Text("(OREA)",style: Typographyy.bodyMediumMedium.copyWith(color: notifire.getGry500_600Color)),
//               ),
//             ),
//             Row(
//               children: [
...
//                       mainAxisAlignment: MainAxisAlignment.center,
//                       children: [
//                         Text("My PortFolio",style: Typographyy.bodyLargeExtraBold.copyWith(color: notifire.getGry500_600Color)),
//
//                         const SizedBox(height: 10,),
//
//                         RichText(text:
//                         TextSpan(children: [
//                           TextSpan(text: "\$ ",style: Typographyy.bodyMediumMedium.copyWith(color: notifire.getGry500_600Color)),
//                           TextSpan(text: "2,955",style: Typographyy.heading3.copyWith(color: notifire.getTextColor,letterSpacing: 1.5))
//
//                         ])),
//                       ],
//                     ),
...
//               mainAxisAlignment: MainAxisAlignment.center,
//               children: [
//                 Text("Official Website",style: Typographyy.bodyMediumMedium.copyWith(color: notifire.getTextColor),),
//                 const SizedBox(width: 8,),
//                 SvgPicture.asset("assets/images/share.svg",height: 20,width: 20,color: notifire.getBgPrimaryColor,),
//
//               ],),
//             SfCircularChart(
...
//                   Row(
//                     children: [
//                       Text("Prev Close",style: Typographyy.bodyMediumExtraBold.copyWith(color: notifire.getGry500_600Color)),
//                       const Spacer(),
//                       Text("\$29,955",style: Typographyy.bodyLargeExtraBold.copyWith(color: notifire.getTextColor)),
//                     ],
//                   ),
//                   const SizedBox(height: 15,),
//                   Row(
//                     children: [
//                       Text("%Change",style: Typographyy.bodyMediumExtraBold.copyWith(color: notifire.getGry500_600Color)),
//                       const Spacer(),
...
//                   Row(
//                     children: [
//                       Text("Market Cap",style: Typographyy.bodyMediumExtraBold.copyWith(color: notifire.getGry500_600Color)),
//                       const Spacer(),
//                       Text("\$29M USD",style: Typographyy.bodyLargeExtraBold.copyWith(color: notifire.getTextColor)),
//                     ],
//                   ),
//                   const SizedBox(height: 15,),
//                   Row(
//                     children: [
//                       Text("PE Ratio",style: Typographyy.bodyMediumExtraBold.copyWith(color: notifire.getGry500_600Color)),
//                       const Spacer(),
//                       Text("29.28%",style: Typographyy.bodyLargeExtraBold.copyWith(color: notifire.getTextColor)),
//                     ],
//                   ),
//                 ],
//               ),
...
//                       ),
//                       onPressed: () {}, child: Text("Sell Stock",style: Typographyy.bodyMediumExtraBold.copyWith(color: notifire.getBgPrimaryColor),)),
//                 ),
//               ],
//             ),
//             const SizedBox(height: 20,),
...
//           mainAxisSize: MainAxisSize.min,
//           children: [
//             Text(title,style: Typographyy.bodyLargeExtraBold.copyWith(color: notifire.getGry500_600Color)),
//             const SizedBox(width: 10,),
...
//               TextSpan(text: "\$ ",style: Typographyy.bodyMediumMedium.copyWith(color: notifire.getGry500_600Color)),
//               TextSpan(text: "$price.00",style: Typographyy.heading4.copyWith(letterSpacing:  1.5,color: notifire.getTextColor)),
//
//             ]))
//       ],
//     );
